...
The second conjunct asks for a stable contract. The contract carries **ten amendment markers across six stamp events** — #109, #230, #694 (2026-09-10), #737 and #743 (both 2026-09-12), and #784 (2026-09-18). *(Corrected 2026-09-18, at the `v0.6.0` cut: this paragraph first said "nine markers across three stamp events," which undercounted by missing the two older §9-area amendments, #109 and #230. My error, counted rather than reasoned the second time; the correction raises the number and so strengthens rather than weakens the point below.)* **Each names what forced it**, and each was forced by work that found something rather than by churn — which is evidence the contract is being *tested*, not that it is unsettled. Stability is judged on whether new work still forces amendments, not on the count of those already taken.
