...
// row carrying an explicit memory index (#127) was written with a comment claiming bit 6 needed no
...
var encodableModules = []struct {
	...
	// # The memarg rows (#127), and **only two of its three fields are here**
	//
...
func TestEncodeRoundTripsThroughTheDecoder(t *testing.T) {
	...
	// table in the same PR that grows it**, or the distance re-opens: #127 added seven rows (84→91,
